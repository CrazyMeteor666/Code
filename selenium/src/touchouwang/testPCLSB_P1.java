...
public class testPCLSB_P1 {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='btnPay']")).click();
		Thread.sleep(3000);
		System.out.println(driver.findElement(By.xpath("//*[@id='newmathCout']")).getAttribute("value"));
		System.out.println(driver.findElement(By.xpath("//*[@id='manjianhou']")).getText());
		System.out.println(driver.findElement(By.xpath("//*[@id='newmathCout']")).getAttribute("value").equals("2000"));
		System.out.println(driver.findElement(By.xpath("//*[@id='manjianhou']")).getText().equals("2,000.00"));
		if (driver.findElement(By.xpath("//*[@id='newmathCout']")).getAttribute("value")=="2000") {
			System.out.println("1");
		} else {
			System.out.println("2");
		}
		if (driver.findElement(By.xpath("//*[@id='manjianhou']")).getText()=="2,000.00") {
			System.out.println("1");
		} else {
			System.out.println("2");
		}
